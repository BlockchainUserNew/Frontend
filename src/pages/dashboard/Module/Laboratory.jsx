...
const LaboratoryRegistration = () => {
  ...
  const AddData = () => {
    ...
    const newData = {
      fname, mname, lname, lab, specialist, gender, email, code, mobile, state, district, taluka, city, GST, file, address, userName, password, cpassword, active, userType: "Laboratory"
    }
    axios
      .post("http://localhost:8080/laboratory/add", newData)
      .then((resp) => {
        console.log(resp);
