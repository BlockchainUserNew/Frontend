        ...
        <>
            <Container>
                                                ...
                                                <>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <Button className='mx-1 bg-danger border-0' onClick={handleShow1}>Send Test to Lab</Button>
                                                        </td>
                                                    </tr>
                                                </>
                                            )
                ...
                <Modal show={show} onHide={handleClose}>
                    ...
                    <Modal.Body><Input type="password" placeholder="Access key" value={accesskey} setValue={setAccesskey} /></Modal.Body>
                    <Modal.Footer>
