...
const DoctorRegistration = () => {
   ...
   // const [cpassword, setCPassword] = useState();
    ...
    const AddData = () => {
        // const newData = {
        //     fname, mname, lname, specialist, gender, email, code, practicingIn, hospital, mobile, state, district, taluka, city, GST, address, userName, password, cpassword, active, userType: "Doctor"
        // }
        ...
        formData.append("practicingIn", practicingIn)
        ...
        axios
            .post("http://localhost:8080/doctor/add", formData, {
                headers: {
